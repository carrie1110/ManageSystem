<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" label="电话" prop="phone" width="170"></el-table-column>
      <el-table-column align="center" label="邮箱" prop="email" width="170"></el-table-column>
      <el-table-column align="center" label="最近修改时间" prop="updateTime" width="170"></el-table-column>
      <el-table-column align="center" label="用戶状态" prop="status" width="170"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form class="small-space" :model="tempUser" label-position="left" label-width="80px"
        ...
        <el-form-item label="邮箱" required>
          ...
          <el-input type="text" v-model="tempUser.status">
          </el-input>
        </el-form-item>
      </el-form>
