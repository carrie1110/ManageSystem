...
import com.ue.portal.service.UserService;
...
public class UserController {
	...
	public JSONObject addUser(@RequestBody JSONObject requestJson) {
		CommonUtil.hasAllRequired(requestJson, "username, password, email, roleId");
	...
	public JSONObject updateUser(@RequestBody JSONObject requestJson) {
		CommonUtil.hasAllRequired(requestJson, " email, roleId, deleteStatus, userId");
